...
public class BackPortal : MonoBehaviour {
	...
	public Camera[] BackPortalCams = null;
	...
	private void LateUpdate() {
		foreach (Camera backPortalCamera in BackPortalCams) {
			Vector3 cameraInSourceSpace = Destination.transform.position;
			...
			backPortalCamera.transform.localPosition = cameraInSourceSpace;
			backPortalCamera.transform.localRotation = cameraInSourceSpaceRot;
			...
			backPortalCamera.fieldOfView = MainCamera.fieldOfView;
			backPortalCamera.aspect = MainCamera.aspect;
		}
	}
}